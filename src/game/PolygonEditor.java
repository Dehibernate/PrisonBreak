...
public class PolygonEditor extends JPanel
{
    ...
    public static void main(String[] args) {
        ...
        //Replace fileName with a String representing the relative path
        //to the image e.g. "images/myimage.png"
        //then right click the PolygonEditor file and choose Run File
        PolygonEditor editor = new PolygonEditor("images/Alien Jump.png", 1);
